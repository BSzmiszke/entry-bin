...
PyObject * itemGetItemName(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (!pItemData)
		return Py_BuildException("no selected item data 1");
...
PyObject * itemGetItemDescription(PyObject * poSelf, PyObject * poArgs)
{
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 2");
...
PyObject * itemGetItemSummary(PyObject * poSelf, PyObject * poArgs)
{
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 3");
...
PyObject * itemGetIconImage(PyObject * poSelf, PyObject * poArgs)
{
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 4");
...
PyObject * itemGetIconImageFileName(PyObject * poSelf, PyObject * poArgs)
{
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 5");
...
PyObject * itemGetItemSize(PyObject * poSelf, PyObject * poArgs)
{
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 6");
...
PyObject * itemGetItemType(PyObject * poSelf, PyObject * poArgs)
{
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 33");
...
PyObject * itemGetItemSubType(PyObject * poSelf, PyObject * poArgs)
{
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 7");
...
PyObject * itemGetIBuyItemPrice(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (!pItemData)
		return Py_BuildException("no selected item data 8");
...
PyObject * itemGetISellItemPrice(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (!pItemData)
		return Py_BuildException("no selected item data 9");
...
PyObject * itemIsAntiFlag(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 10");
...
PyObject * itemIsFlag(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 11");
...
PyObject * itemIsWearableFlag(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 12");
...
PyObject * itemIs1GoldItem(PyObject * poSelf, PyObject * poArgs)
{
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("no selected item data 13");
...
PyObject * itemGetLimit(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("Not yet select item data 14");
...
PyObject * itemGetAffect(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("Not yet select item data 15");
...
PyObject * itemGetValue(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("Not yet select item data 16");
...
PyObject * itemGetSocket(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("Not yet select item data 17");
...
PyObject * itemGetIconInstance(PyObject * poSelf, PyObject * poArgs)
{
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("Not yet select item data 18");
...
PyObject * itemIsEquipmentVID(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("Not yet select item data 19");
...
PyObject* itemGetUseType(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("Can't find select item data20");
...
PyObject * itemIsRefineScroll(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("Can't find select item data 21");
...
PyObject * itemIsDetachScroll(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("Can't find select item data 22");
...
PyObject * itemCanAddToQuickSlotItem(PyObject * poSelf, PyObject * poArgs)
{
	...
	CItemData * pItemData = CItemManager::Instance().GetSelectedItemDataPointer();
	if (!pItemData)
		return Py_BuildException("Can't find select item data 23");
