...
{
	return (race >= CRaceManager::MONSTER_RACE_MIN && race <= CRaceManager::MONSTER_RACE_MAX) || (race >= CRaceManager::MONSTER_RACE_METIN_MIN && race <= CRaceManager::MONSTER_RACE_METIN_MAX);
}

bool IsMonster2Race(uint32_t race) 
{
	return (race >= CRaceManager::MONSTER2_RACE_MIN && race <= CRaceManager::MONSTER2_RACE_MAX) || race == CRaceManager::MONSTER2_RACE_SPECIAL1 ||
		race == CRaceManager::MONSTER2_RACE_SPECIAL2 || race > CRaceManager::MONSTER2_RACE_START_RANGE;
}
